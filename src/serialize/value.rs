...
use pyo3::prelude::*;
use pyo3::types::{PyAny, PyBytes, PyDict, PyList, PyMapping, PySet, PyTuple};
...
use scylla::serialize::value::{
    ...
    SetOrListSerializationErrorKind, SetOrListTypeCheckErrorKind, UdtTypeCheckErrorKind,
};
...
impl<'a, 'py> PyAnyWrapper<'a, 'py> {
    ...
    fn serialize_natives<'b>(
        ...
        match native_type {
            ...
            // Text types.
            NativeType::Ascii => self.serialize_native::<&str>(typ, cell_writer),
    ...
    where
        // T: for<'c> pyo3::FromPyObject<'c, 'py> + SerializeValue,
